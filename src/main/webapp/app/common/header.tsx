            ...
            <ul className="flex">
              ...
              <li className="relative">
                ...
                <ul className="hidden block absolute right-0 bg-white border border-gray-300 rounded min-w-[10rem] py-2" aria-labelledby="navbarEntitiesLink">
                  ...
                  <li><Link to="/accounts" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('account.list.headline')}</Link></li>
                  <li><Link to="/transactions" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('transaction.list.headline')}</Link></li>
                  <li><Link to="/fraudAlerts" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('fraudAlert.list.headline')}</Link></li>
                  <li><Link to="/kycDocuments" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('kycDocument.list.headline')}</Link></li>
                  <li><Link to="/settlements" className="inline-block w-full hover:bg-gray-200 px-4 py-1">{t('settlement.list.headline')}</Link></li>
                </ul>
              </li>
            </ul>
          </div>
