...
function getSchema() {
  ...
  return yup.object({
    ...
    phone: yup.string().emptyToNull().max(15),
    fullName: yup.string().emptyToNull().max(100),
    kycStatus: yup.string().emptyToNull().max(255),
...
export default function UserEdit() {
  ...
  return (<>
    ...
    <form onSubmit={useFormResult.handleSubmit(updateUser)} noValidate>
      ...
      <InputRow useFormResult={useFormResult} object="user" field="phone" />
      <InputRow useFormResult={useFormResult} object="user" field="fullName" />
      <InputRow useFormResult={useFormResult} object="user" field="kycStatus" />
